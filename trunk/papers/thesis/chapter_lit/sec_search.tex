...
search strategies we have discussed this far. Such efforts typically focus
...
of states that need to be explored during search.  Needless to say these methods need not be applied
independently. As we will see they can be, and often are, very successfully combined.
