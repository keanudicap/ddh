...
neighbours.  Figure \ref{fig::rsr::branching} (Left) shows an example.  As we will see
...
\begin{figure}[t]
	...
	{chapter_rsr/diagrams/branching_wide.png}
	\end{center}
	\vspace{-3pt}
	\caption[RSR enhancements: perimeter reduction and online pruning]
    {\small
    (Left) From each empty rectangle we prune all (dark grey) nodes which
...
and its predecessor belong to the same rectangle. Figure \ref{fig::rsr::branching}
